...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nightwatch/node_modules/nightwatch/lib/runner/cli/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nightwatch/node_modules/nightwatch/lib/runner/cli/cli.js</span></h1>
    <h2>
        
        Statements: <span class="metric">92.98% <small>(53 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">92.98% <small>(53 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nightwatch/node_modules/nightwatch/lib/runner/cli/</a> &#187; cli.js</div>
</div>
<div class="body">
...
&nbsp;
  Command.prototype.demand = function(value) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!value &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >_DEFAULTS_[this.name].demand)</span> {
<span class="cstat-no" title="statement not covered" >      return _DEFAULTS_[this.name].demand;</span>
    }
...
&nbsp;
  Command.prototype.description = function(value) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!value &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >_DEFAULTS_[this.name].description)</span> {
<span class="cstat-no" title="statement not covered" >      return _DEFAULTS_[this.name].alias;</span>
    }
...
&nbsp;
  Command.prototype.alias = function(value) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!value &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >_DEFAULTS_[this.name].alias)</span> {
<span class="cstat-no" title="statement not covered" >      return _DEFAULTS_[this.name].alias;</span>
    }
...
&nbsp;
&nbsp;
  this.showHelp = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    return opt.showHelp();</span>
  };
&nbsp;
